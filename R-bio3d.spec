...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/bio3d_2.4-5.tar.gz
...
%setup -q -n bio3d
pushd ..
cp -a bio3d buildavx2
popd
pushd ..
cp -a bio3d buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731636951
...
/usr/lib64/R/library/bio3d/NEWS.md
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/bio3d/libs/bio3d.so
/V4/usr/lib64/R/library/bio3d/libs/bio3d.so
